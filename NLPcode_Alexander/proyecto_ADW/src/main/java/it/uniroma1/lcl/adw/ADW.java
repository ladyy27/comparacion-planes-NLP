...
/**
 * A class to compute the semantic similarity of arbitrary pairs of lexical
 * items
 *
 * @author pilehvar
 *
...
//        demo();
        ...
        String text1 = "PHYSICS FOR BIOMEDICAL SCIENCES";
        ItemType text1Type = ItemType.SURFACE;

        String text2 = "STATISTICS II";
		...
		System.out.println("Método de Medida: " + measure.toString());
		System.out.println("Desambiguación: " + disMethod.toString());
