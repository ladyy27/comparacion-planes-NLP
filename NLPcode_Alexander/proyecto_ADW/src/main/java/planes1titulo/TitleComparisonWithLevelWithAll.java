...
public class TitleComparisonWithLevelWithAll {
...
//		dbObject.cleanResultsDB(conn);
		Triple triple = dbObject.getTitleFromDB(conn, "CURSO_PRE-TNICI040_18");
		...
		for (Triple triple1 : triples) {
			...
			dbObject.storeTitlesComparisonWithLevelToDB(conn, triple.getS(), triple.getO(), triple1.getS(),
					triple1.getO(), score);
