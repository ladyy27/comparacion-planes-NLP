...
public class ADWTest {
    ...
    public void testWeightedOverlap() {
        ...
        String text1 = "The problem likely will mean corrective changes before the shuttle fleet starts flying again.";
        ItemType text1Type = ItemType.SURFACE;

//        String text2 = "windmill#n rotate#v wind#n";
//        ItemType text2Type = ItemType.SURFACE_TAGGED;
        
        String text2 = "He said the problem needs to be corrected before the space shuttle fleet is cleared to fly again.";
